# Fairphone 5. Adapted from ../../diskoConfigs/btrfs-luks-encryption.nix.
#
# Partition mapping on this device:
#   nixos-boot -> super      (6GiB). The FP5 has no physical `system`
#                             partition; system_a/b are logical inside super
#                             and flashing those needs fastbootd.
#   nixos-root -> userdata   (214GiB)
#
